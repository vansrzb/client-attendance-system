    ...
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row sm:items-end gap-3">
      <div className="space-y-1">
        ...
        <Input
          ...
          className="w-fit sm:w-56 h-9 text-sm"
        />
      </div>
      ...
      <div className="space-y-1">
        ...
        <Select onValueChange={setClassType} value={classType}>
          <SelectTrigger className="w-fit sm:w-36 h-9 text-sm">
      ...
      <Button
        type="submit"
        disabled={loading}
        className="w-fit sm:w-auto h-9 bg-green-600 hover:bg-green-700 text-white text-sm"
      >
