...
export default function ClassTable({ classes, onDeleted, onSelect, selected }: Props) {
  ...
  if (!classes.length)
    return <p className="text-sm text-gray-400 py-6 text-center">No classes yet.</p>;
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-gray-50 border-b border-gray-100">
            <th className="text-left px-4 py-3 text-xs font-medium text-gray-500">Class Name</th>
